...
public class FireballAbility : BaseAbility
{
    ...
    public override IEnumerator Initiate(Character _target)
    {
        ...
        fbPrefabClone = GameObject.Instantiate(Resources.Load("Prefabs/FireballPrefab") as GameObject, character.transform.position, Quaternion.identity) as GameObject;
        isAttacking = true;
        ...
        while (!Mathf.Approximately(currentTime, 1.0f))
        {
            ...
            float frameValue = (1f - 0f) * EasingEquations.EaseOutQuad(0.0f, 1.0f, currentTime) + 0f;
