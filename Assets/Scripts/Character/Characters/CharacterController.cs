...
public abstract class CharacterController : StateMachine {
    ...
    public void Attack(CharacterController _target, AttackAbility _ability)
    {
    ...
    public void OnTurnEnd(CharacterController character)
    {
        fillAP();
    }
